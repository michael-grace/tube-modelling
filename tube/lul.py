...
class DeepTubeLinePlatform(tube.core.Platform):
    def __init__(self,
                 name: str,
                 entrances: list[tube.core.PlatformEntrance],
                 loading_type: tube.core.LoadingType,
                 yearly_passengers: int,
                 trains_per_hour: int):
...
class DeepTubeTrain(tube.core.Train):
    ...
    def run_journey(self, platforms: list[DeepTubeLinePlatform]):
        for platform in platforms:
            ...
            self.empty_train(platform.passengers_per_train,
                             platform.loading_type)
